...
export default function App() {
  ...
  const handleBuyTicket = async (eventName: string) => {
    setStatus({
      message: `Processing payment for ${eventName}...`,
      error: false,
    });
    ...
    >
        ...
        <div style={formStyle}>
          ...
          {formData.userType === "MIT" && (
            <>
              ...
              <input
                name="learnerEmail"
                placeholder="Learner Email (@learner.manipal.edu)"
                onChange={handleChange}
                style={inputStyle}
              />
            </>
          ...
          <p style={{ fontSize: "0.9rem" }}>
            ...
            <span style={linkStyle} onClick={() => setStep("LOGIN")}>
              Login
            </span>
          </p>
        </div>
      ...
      {step === "LOGIN" && (
        <div style={formStyle}>
          ...
          <input
            name={
              formData.userType === "MIT" ? "learnerEmail" : "personalEmail"
            }
            placeholder="Email"
              ...
              >
                ...
                <div>
                  ...
                  <div style={cardStyle}>
                    ...
                    <p>Price: ₹500</p>
                    <button
                      onClick={() => handleBuyTicket("Revels 2025")}
                      style={buttonStyle}
                    >
                      Buy Ticket
                    </button>
                  ...
                  <div style={{ ...cardStyle, marginTop: "10px" }}>
                    ...
                    <p>Price: ₹800</p>
                    <button
                      onClick={() => handleBuyTicket("TechTatva Pro")}
                      style={buttonStyle}
                    >
                      Buy Ticket
                    </button>
